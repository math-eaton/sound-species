...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Fo(){return new Cn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ha(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Oo(){return new Cn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ha(),fragmentShader:`
...
`)}function Jp(i,e){let t;switch(e){case zc:t="Linear";break;case kc:t="Reinhard";break;case Hc:t="Cineon";break;case Vc:t="ACESFilmic";break;case Wc:t="AgX";break;case Xc:t="Neutral";break;case Gc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Pr=new I;function Qp(){Xe.getLuminanceCoefficients(Pr);const i=Pr.x.toFixed(4),e=Pr.y.toFixed(4),t=Pr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function lm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===vl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===vc?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===cn&&(e="SHADOWMAP_TYPE_VSM"),e}function cm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ai:case wi:e="ENVMAP_TYPE_CUBE";break;case Zr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function um(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case wi:e="ENVMAP_MODE_REFRACTION";break}return e}function hm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case xl:e="ENVMAP_BLENDING_MULTIPLY";break;case Oc:e="ENVMAP_BLENDING_MIX";break;case Bc:e="ENVMAP_BLENDING_ADD";break}return e}function dm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function fm(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=lm(t),c=cm(t),u=um(t),d=hm(t),f=dm(t),p=em(t),_=tm(s),v=r.createProgram();let m,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Wi).join(`
`)),a=Ma(a),a=Ko(a,t),a=Zo(a,t),o=Ma(o),o=Ko(o,t),o=Zo(o,t),a=$o(a),o=$o(o),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
</div>`,p_=function(e,t){var n=e[t];return Y.isArray(arguments[2])||Y.isObject(arguments[2])?new o_(e,t,arguments[2]):Y.isNumber(n)?Y.isNumber(arguments[2])&&Y.isNumber(arguments[3])?Y.isNumber(arguments[4])?new ya(e,t,arguments[2],arguments[3],arguments[4]):new ya(e,t,arguments[2],arguments[3]):Y.isNumber(arguments[4])?new qr(e,t,{min:arguments[2],max:arguments[3],step:arguments[4]}):new qr(e,t,{min:arguments[2],max:arguments[3]}):Y.isString(n)?new l_(e,t):Y.isFunction(n)?new Ql(e,t,""):Y.isBoolean(n)?new jl(e,t):null};function m_(i){setTimeout(i,1e3/60)}var __=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||m_,g_=function(){function i(){Zt(this,i),this.backgroundElement=document.createElement("div"),Y.extend(this.backgroundElement.style,{backgroundColor:"rgba(0,0,0,0.8)",top:0,left:0,display:"none",zIndex:"1000",opacity:0,WebkitTransition:"opacity 0.2s linear",transition:"opacity 0.2s linear"}),O.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position="fixed",this.domElement=document.createElement("div"),Y.extend(this.domElement.style,{position:"fixed",display:"none",zIndex:"1001",opacity:0,WebkitTransition:"-webkit-transform 0.2s ease-out, opacity 0.2s linear",transition:"transform 0.2s ease-out, opacity 0.2s linear"}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var e=this;O.bind(this.backgroundElement,"click",function(){e.hide()})}return $t(i,[{key:"show",value:function(){var t=this;this.backgroundElement.style.display="block",this.domElement.style.display="block",this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)",this.layout(),Y.defer(function(){t.backgroundElement.style.opacity=1,t.domElement.style.opacity=1,t.domElement.style.webkitTransform="scale(1)"})}},{key:"hide",value:function(){var t=this,n=function r(){t.domElement.style.display="none",t.backgroundElement.style.display="none",O.unbind(t.domElement,"webkitTransitionEnd",r),O.unbind(t.domElement,"transitionend",r),O.unbind(t.domElement,"oTransitionEnd",r)};O.bind(this.domElement,"webkitTransitionEnd",n),O.bind(this.domElement,"transitionend",n),O.bind(this.domElement,"oTransitionEnd",n),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)"}},{key:"layout",value:function(){this.domElement.style.left=window.innerWidth/2-O.getWidth(this.domElement)/2+"px",this.domElement.style.top=window.innerHeight/2-O.getHeight(this.domElement)/2+"px"}}]),i}(),v_=n_(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);d_.inject(v_);var ll="dg",cl=72,ul=20,Ji="Default",Xi=function(){try{return!!window.localStorage}catch{return!1}}(),Ki=void 0,hl=!0,mi=void 0,Us=!1,ec=[],tt=function i(e){var t=this,n=e||{};this.domElement=document.createElement("div"),this.__ul=document.createElement("ul"),this.domElement.appendChild(this.__ul),O.addClass(this.domElement,ll),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],n=Y.defaults(n,{closeOnTop:!1,autoPlace:!0,width:i.DEFAULT_WIDTH}),n=Y.defaults(n,{resizable:n.autoPlace,hideable:n.autoPlace}),Y.isUndefined(n.load)?n.load={preset:Ji}:n.preset&&(n.load.preset=n.preset),Y.isUndefined(n.parent)&&n.hideable&&ec.push(this),n.resizable=Y.isUndefined(n.parent)&&n.resizable,n.autoPlace&&Y.isUndefined(n.scrollable)&&(n.scrollable=!0);var r=Xi&&localStorage.getItem(_i(this,"isLocal"))==="true",s=void 0,a=void 0;if(Object.defineProperties(this,{parent:{get:function(){return n.parent}},scrollable:{get:function(){return n.scrollable}},autoPlace:{get:function(){return n.autoPlace}},closeOnTop:{get:function(){return n.closeOnTop}},preset:{get:function(){return t.parent?t.getRoot().preset:n.load.preset},set:function(f){t.parent?t.getRoot().preset=f:n.load.preset=f,E_(this),t.revert()}},width:{get:function(){return n.width},set:function(f){n.width=f,wa(t,f)}},name:{get:function(){return n.name},set:function(f){n.name=f,a&&(a.innerHTML=n.name)}},closed:{get:function(){return n.closed},set:function(f){n.closed=f,n.closed?O.addClass(t.__ul,i.CLASS_CLOSED):O.removeClass(t.__ul,i.CLASS_CLOSED),this.onResize(),t.__closeButton&&(t.__closeButton.innerHTML=f?i.TEXT_OPEN:i.TEXT_CLOSED)}},load:{get:function(){return n.load}},useLocalStorage:{get:function(){return r},set:function(f){Xi&&(r=f,f?O.bind(window,"unload",s):O.unbind(window,"unload",s),localStorage.setItem(_i(t,"isLocal"),f))}}}),Y.isUndefined(n.parent)){if(this.closed=n.closed||!1,O.addClass(this.domElement,i.CLASS_MAIN),O.makeSelectable(this.domElement,!1),Xi&&r){t.useLocalStorage=!0;var o=localStorage.getItem(_i(this,"gui"));o&&(n.load=JSON.parse(o))}this.__closeButton=document.createElement("div"),this.__closeButton.innerHTML=i.TEXT_CLOSED,O.addClass(this.__closeButton,i.CLASS_CLOSE_BUTTON),n.closeOnTop?(O.addClass(this.__closeButton,i.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):(O.addClass(this.__closeButton,i.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),O.bind(this.__closeButton,"click",function(){t.closed=!t.closed})}else{n.closed===void 0&&(n.closed=!0);var l=document.createTextNode(n.name);O.addClass(l,"controller-name"),a=Xa(t,l);var c=function(f){return f.preventDefault(),t.closed=!t.closed,!1};O.addClass(this.__ul,i.CLASS_CLOSED),O.addClass(a,"title"),O.bind(a,"click",c),n.closed||(this.closed=!1)}n.autoPlace&&(Y.isUndefined(n.parent)&&(hl&&(mi=document.createElement("div"),O.addClass(mi,ll),O.addClass(mi,i.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(mi),hl=!1),mi.appendChild(this.domElement),O.addClass(this.domElement,i.CLASS_AUTO_PLACE)),this.parent||wa(t,n.width)),this.__resizeHandler=function(){t.onResizeDebounced()},O.bind(window,"resize",this.__resizeHandler),O.bind(this.__ul,"webkitTransitionEnd",this.__resizeHandler),O.bind(this.__ul,"transitionend",this.__resizeHandler),O.bind(this.__ul,"oTransitionEnd",this.__resizeHandler),this.onResize(),n.resizable&&M_(this),s=function(){Xi&&localStorage.getItem(_i(t,"isLocal"))==="true"&&localStorage.setItem(_i(t,"gui"),JSON.stringify(t.getSaveObject()))},this.saveToLocalStorageIfPossible=s;function u(){var d=t.getRoot();d.width+=1,Y.defer(function(){d.width-=1})}n.parent||u()};tt.toggleHide=function(){Us=!Us,Y.each(ec,function(i){i.domElement.style.display=Us?"none":""})};tt.CLASS_AUTO_PLACE="a";tt.CLASS_AUTO_PLACE_CONTAINER="ac";tt.CLASS_MAIN="main";tt.CLASS_CONTROLLER_ROW="cr";tt.CLASS_TOO_TALL="taller-than-window";tt.CLASS_CLOSED="closed";tt.CLASS_CLOSE_BUTTON="close-button";tt.CLASS_CLOSE_TOP="close-top";tt.CLASS_CLOSE_BOTTOM="close-bottom";tt.CLASS_DRAG="drag";tt.DEFAULT_WIDTH=245;tt.TEXT_CLOSED="Close Controls";tt.TEXT_OPEN="Open Controls";tt._keydownHandler=function(i){document.activeElement.type!=="text"&&(i.which===cl||i.keyCode===cl)&&tt.toggleHide()};O.bind(window,"keydown",tt._keydownHandler,!1);Y.extend(tt.prototype,{add:function(e,t){return Zi(this,e,t,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(e,t){return Zi(this,e,t,{color:!0})},remove:function(e){this.__ul.removeChild(e.__li),this.__controllers.splice(this.__controllers.indexOf(e),1);var t=this;Y.defer(function(){t.onResize()})},destroy:function(){if(this.parent)throw new Error("Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.");this.autoPlace&&mi.removeChild(this.domElement);var e=this;Y.each(this.__folders,function(t){e.removeFolder(t)}),O.unbind(window,"keydown",tt._keydownHandler,!1),dl(this)},addFolder:function(e){if(this.__folders[e]!==void 0)throw new Error('You already have a folder in this GUI by the name "'+e+'"');var t={name:e,parent:this};t.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[e]&&(t.closed=this.load.folders[e].closed,t.load=this.load.folders[e]);var n=new tt(t);this.__folders[e]=n;var r=Xa(this,n.domElement);return O.addClass(r,"folder"),n},removeFolder:function(e){this.__ul.removeChild(e.domElement.parentElement),delete this.__folders[e.name],this.load&&this.load.folders&&this.load.folders[e.name]&&delete this.load.folders[e.name],dl(e);var t=this;Y.each(e.__folders,function(n){e.removeFolder(n)}),Y.defer(function(){t.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display="none"},show:function(){this.domElement.style.display=""},onResize:function(){var e=this.getRoot();if(e.scrollable){var t=O.getOffset(e.__ul).top,n=0;Y.each(e.__ul.childNodes,function(r){e.autoPlace&&r===e.__save_row||(n+=O.getHeight(r))}),window.innerHeight-t-ul<n?(O.addClass(e.domElement,tt.CLASS_TOO_TALL),e.__ul.style.height=window.innerHeight-t-ul+"px"):(O.removeClass(e.domElement,tt.CLASS_TOO_TALL),e.__ul.style.height="auto")}e.__resize_handle&&Y.defer(function(){e.__resize_handle.style.height=e.__ul.offsetHeight+"px"}),e.__closeButton&&(e.__closeButton.style.width=e.width+"px")},onResizeDebounced:Y.debounce(function(){this.onResize()},50),remember:function(){if(Y.isUndefined(Ki)&&(Ki=new g_,Ki.domElement.innerHTML=f_),this.parent)throw new Error("You can only call remember on a top level GUI.");var e=this;Y.each(Array.prototype.slice.call(arguments),function(t){e.__rememberedObjects.length===0&&S_(e),e.__rememberedObjects.indexOf(t)===-1&&e.__rememberedObjects.push(t)}),this.autoPlace&&wa(this,this.width)},getRoot:function(){for(var e=this;e.parent;)e=e.parent;return e},getSaveObject:function(){var e=this.load;return e.closed=this.closed,this.__rememberedObjects.length>0&&(e.preset=this.preset,e.remembered||(e.remembered={}),e.remembered[this.preset]=Ur(this)),e.folders={},Y.each(this.__folders,function(t,n){e.folders[n]=t.getSaveObject()}),e},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=Ur(this),Ta(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(e){this.load.remembered||(this.load.remembered={},this.load.remembered[Ji]=Ur(this,!0)),this.load.remembered[e]=Ur(this),this.preset=e,Aa(this,e,!0),this.saveToLocalStorageIfPossible()},revert:function(e){Y.each(this.__controllers,function(t){this.getRoot().load.remembered?tc(e||this.getRoot(),t):t.setValue(t.initialValue),t.__onFinishChange&&t.__onFinishChange.call(t,t.getValue())},this),Y.each(this.__folders,function(t){t.revert(t)}),e||Ta(this.getRoot(),!1)},listen:function(e){var t=this.__listening.length===0;this.__listening.push(e),t&&nc(this.__listening)},updateDisplay:function(){Y.each(this.__controllers,function(e){e.updateDisplay()}),Y.each(this.__folders,function(e){e.updateDisplay()})}});function Xa(i,e,t){var n=document.createElement("li");return e&&n.appendChild(e),t?i.__ul.insertBefore(n,t):i.__ul.appendChild(n),i.onResize(),n}function dl(i){O.unbind(window,"resize",i.__resizeHandler),i.saveToLocalStorageIfPossible&&O.unbind(window,"unload",i.saveToLocalStorageIfPossible)}function Ta(i,e){var t=i.__preset_select[i.__preset_select.selectedIndex];e?t.innerHTML=t.value+"*":t.innerHTML=t.value}function x_(i,e,t){if(t.__li=e,t.__gui=i,Y.extend(t,{options:function(a){if(arguments.length>1){var o=t.__li.nextElementSibling;return t.remove(),Zi(i,t.object,t.property,{before:o,factoryArgs:[Y.toArray(arguments)]})}if(Y.isArray(a)||Y.isObject(a)){var l=t.__li.nextElementSibling;return t.remove(),Zi(i,t.object,t.property,{before:l,factoryArgs:[a]})}},name:function(a){return t.__li.firstElementChild.firstElementChild.innerHTML=a,t},listen:function(){return t.__gui.listen(t),t},remove:function(){return t.__gui.remove(t),t}}),t instanceof ya){var n=new qr(t.object,t.property,{min:t.__min,max:t.__max,step:t.__step});Y.each(["updateDisplay","onChange","onFinishChange","step","min","max"],function(s){var a=t[s],o=n[s];t[s]=n[s]=function(){var l=Array.prototype.slice.call(arguments);return o.apply(n,l),a.apply(t,l)}}),O.addClass(e,"has-slider"),t.domElement.insertBefore(n.domElement,t.domElement.firstElementChild)}else if(t instanceof qr){var r=function(a){if(Y.isNumber(t.__min)&&Y.isNumber(t.__max)){var o=t.__li.firstElementChild.firstElementChild.innerHTML,l=t.__gui.__listening.indexOf(t)>-1;t.remove();var c=Zi(i,t.object,t.property,{before:t.__li.nextElementSibling,factoryArgs:[t.__min,t.__max,t.__step]});return c.name(o),l&&c.listen(),c}return a};t.min=Y.compose(r,t.min),t.max=Y.compose(r,t.max)}else t instanceof jl?(O.bind(e,"click",function(){O.fakeEvent(t.__checkbox,"click")}),O.bind(t.__checkbox,"click",function(s){s.stopPropagation()})):t instanceof Ql?(O.bind(e,"click",function(){O.fakeEvent(t.__button,"click")}),O.bind(e,"mouseover",function(){O.addClass(t.__button,"hover")}),O.bind(e,"mouseout",function(){O.removeClass(t.__button,"hover")})):t instanceof ba&&(O.addClass(e,"color"),t.updateDisplay=Y.compose(function(s){return e.style.borderLeftColor=t.__color.toString(),s},t.updateDisplay),t.updateDisplay());t.setValue=Y.compose(function(s){return i.getRoot().__preset_select&&t.isModified()&&Ta(i.getRoot(),!0),s},t.setValue)}function tc(i,e){var t=i.getRoot(),n=t.__rememberedObjects.indexOf(e.object);if(n!==-1){var r=t.__rememberedObjectIndecesToControllers[n];if(r===void 0&&(r={},t.__rememberedObjectIndecesToControllers[n]=r),r[e.property]=e,t.load&&t.load.remembered){var s=t.load.remembered,a=void 0;if(s[i.preset])a=s[i.preset];else if(s[Ji])a=s[Ji];else return;if(a[n]&&a[n][e.property]!==void 0){var o=a[n][e.property];e.initialValue=o,e.setValue(o)}}}}function Zi(i,e,t,n){if(e[t]===void 0)throw new Error('Object "'+e+'" has no property "'+t+'"');var r=void 0;if(n.color)r=new ba(e,t);else{var s=[e,t].concat(n.factoryArgs);r=p_.apply(i,s)}n.before instanceof jn&&(n.before=n.before.__li),tc(i,r),O.addClass(r.domElement,"c");var a=document.createElement("span");O.addClass(a,"property-name"),a.innerHTML=r.property;var o=document.createElement("div");o.appendChild(a),o.appendChild(r.domElement);var l=Xa(i,o,n.before);return O.addClass(l,tt.CLASS_CONTROLLER_ROW),r instanceof ba?O.addClass(l,"color"):O.addClass(l,r_(r.getValue())),x_(i,l,r),i.__controllers.push(r),r}function _i(i,e){return document.location.href+"."+e}function Aa(i,e,t){var n=document.createElement("option");n.innerHTML=e,n.value=e,i.__preset_select.appendChild(n),t&&(i.__preset_select.selectedIndex=i.__preset_select.length-1)}function fl(i,e){e.style.display=i.useLocalStorage?"block":"none"}function S_(i){var e=i.__save_row=document.createElement("li");O.addClass(i.domElement,"has-save"),i.__ul.insertBefore(e,i.__ul.firstChild),O.addClass(e,"save-row");var t=document.createElement("span");t.innerHTML="&nbsp;",O.addClass(t,"button gears");var n=document.createElement("span");n.innerHTML="Save",O.addClass(n,"button"),O.addClass(n,"save");var r=document.createElement("span");r.innerHTML="New",O.addClass(r,"button"),O.addClass(r,"save-as");var s=document.createElement("span");s.innerHTML="Revert",O.addClass(s,"button"),O.addClass(s,"revert");var a=i.__preset_select=document.createElement("select");if(i.load&&i.load.remembered?Y.each(i.load.remembered,function(d,f){Aa(i,f,f===i.preset)}):Aa(i,Ji,!1),O.bind(a,"change",function(){for(var d=0;d<i.__preset_select.length;d++)i.__preset_select[d].innerHTML=i.__preset_select[d].value;i.preset=this.value}),e.appendChild(a),e.appendChild(t),e.appendChild(n),e.appendChild(r),e.appendChild(s),Xi){var o=document.getElementById("dg-local-explain"),l=document.getElementById("dg-local-storage"),c=document.getElementById("dg-save-locally");c.style.display="block",localStorage.getItem(_i(i,"isLocal"))==="true"&&l.setAttribute("checked","checked"),fl(i,o),O.bind(l,"change",function(){i.useLocalStorage=!i.useLocalStorage,fl(i,o)})}var u=document.getElementById("dg-new-constructor");O.bind(u,"keydown",function(d){d.metaKey&&(d.which===67||d.keyCode===67)&&Ki.hide()}),O.bind(t,"click",function(){u.innerHTML=JSON.stringify(i.getSaveObject(),void 0,2),Ki.show(),u.focus(),u.select()}),O.bind(n,"click",function(){i.save()}),O.bind(r,"click",function(){var d=prompt("Enter a new preset name.");d&&i.saveAs(d)}),O.bind(s,"click",function(){i.revert()})}function M_(i){var e=void 0;i.__resize_handle=document.createElement("div"),Y.extend(i.__resize_handle.style,{width:"6px",marginLeft:"-3px",height:"200px",cursor:"ew-resize",position:"absolute"});function t(s){return s.preventDefault(),i.width+=e-s.clientX,i.onResize(),e=s.clientX,!1}function n(){O.removeClass(i.__closeButton,tt.CLASS_DRAG),O.unbind(window,"mousemove",t),O.unbind(window,"mouseup",n)}function r(s){return s.preventDefault(),e=s.clientX,O.addClass(i.__closeButton,tt.CLASS_DRAG),O.bind(window,"mousemove",t),O.bind(window,"mouseup",n),!1}O.bind(i.__resize_handle,"mousedown",r),O.bind(i.__closeButton,"mousedown",r),i.domElement.insertBefore(i.__resize_handle,i.domElement.firstElementChild)}function wa(i,e){i.domElement.style.width=e+"px",i.__save_row&&i.autoPlace&&(i.__save_row.style.width=e+"px"),i.__closeButton&&(i.__closeButton.style.width=e+"px")}function Ur(i,e){var t={};return Y.each(i.__rememberedObjects,function(n,r){var s={},a=i.__rememberedObjectIndecesToControllers[r];Y.each(a,function(o,l){s[l]=e?o.initialValue:o.getValue()}),t[r]=s}),t}function E_(i){for(var e=0;e<i.__preset_select.length;e++)i.__preset_select[e].value===i.preset&&(i.__preset_select.selectedIndex=e)}function nc(i){i.length!==0&&__.call(window,function(){nc(i)}),Y.each(i,function(e){e.updateDisplay()})}var y_=tt;const je={sphereOpacity:.85,sphereSize:.35,showEllipses:!0,ellipseColor:"#ffffff",ellipseOpacity:.66,showInterLines:!0,interLineColor:"#ffffff",interLineOpacity:.5,showIntraLines:!0,intraLineColor:"#ffffff",intraLineOpacity:.5,recessionVelocity:4,BPM:107.333,phaseOffset:11},bn=new Ku;bn.background=new Ge(134413);const Qi=new Ot(60,window.innerWidth/window.innerHeight,.1,1500);Qi.position.set(0,0,15);const Ii=new Hm({antialias:!1});Ii.setSize(window.innerWidth,window.innerHeight);Ii.domElement.className="three-container";document.body.appendChild(Ii.domElement);let tn=new Gm(Qi,Ii.domElement);tn.enableDamping=!0;tn.dampingFactor=.5;tn.enableZoom=!1;tn.enablePan=!1;tn.rotateSpeed=.05;const Qr=Oa.degToRad(10);tn.minPolarAngle=Math.PI/2-Qr;tn.maxPolarAngle=Math.PI/2+Qr;tn.minAzimuthAngle=-Qr;tn.maxAzimuthAngle=Qr;window.addEventListener("resize",()=>{Qi.aspect=window.innerWidth/window.innerHeight,Qi.updateProjectionMatrix(),Ii.setSize(window.innerWidth,window.innerHeight)});const Ya=new y_({name:"UI",closeOnTop:!0,useLocalStorage:!0}),rr=Ya.addFolder("APPEARANCE"),ic=rr.addFolder("SPHERES");ic.add(je,"sphereOpacity",0,1,.01).name("opacity").onChange(i=>{Tn.forEach(e=>{e.children.forEach(t=>{t.isMesh&&(t.material.opacity=i)})})});ic.add(je,"sphereSize",.1,2,.01).name("size").onChange(i=>{Tn.forEach(e=>{e.children.forEach(t=>{t.isMesh&&t.scale.set(i,i,i)})})});const b_=rr.addFolder("ELLIPSES");b_.add(je,"ellipseOpacity",0,1,.01).name("opacity").onChange(i=>{Tn.forEach(e=>{const t=e.children[0];t&&t.material&&(t.material.opacity=i)})});const T_=rr.addFolder("INTER");T_.add(je,"interLineOpacity",0,1,.01).name("opacity").onChange(i=>{Wn.forEach(e=>{e.material&&(e.material.opacity=i)})});const A_=rr.addFolder("INTRA");A_.add(je,"intraLineOpacity",0,1,.01).name("opacity").onChange(i=>{Si.forEach(e=>{e.material&&(e.material.opacity=i)})});const qa=Ya.addFolder("TIMING");qa.add(je,"recessionVelocity",-1,10,.5).name("VELOCITY");qa.add(je,"BPM",30,200,1).name("BPM").onChange(i=>{Ra=i,Kr=4*60/Ra,rc=Kr});qa.add(je,"phaseOffset",0,360,1).name("PHASE OFFSET").onChange(i=>{P_=i});rr.open();Ya.close();let Ra=je.BPM,Kr=4*60/Ra,rc=Kr;function w_(i,e,t=120){const r=new Ju(0,0,i,e,0,2*Math.PI).getPoints(t),s=new zt().setFromPoints(r),a=s.attributes.position.array;for(let o=0;o<a.length;o+=3){const l=a[o+1];a[o+1]=0,a[o+2]=l}return s}const sc=10,ac=7,R_=w_(sc,ac),sr=[{color:16711680,numSteps:8,pattern:new Array(16).fill(!1),stepsInput:document.getElementById("redStepsInput"),patternContainer:document.getElementById("redPattern")},{color:16776960,numSteps:8,pattern:new Array(16).fill(!1),stepsInput:document.getElementById("yellowStepsInput"),patternContainer:document.getElementById("yellowPattern")},{color:255,numSteps:8,pattern:new Array(16).fill(!1),stepsInput:document.getElementById("blueStepsInput"),patternContainer:document.getElementById("bluePattern")}];sr[0].pattern[0]=!0;sr[1].pattern[3]=!0;sr[2].pattern[4]=!0;function pl(i){i.patternContainer.innerHTML="";for(let e=0;e<i.numSteps;e++){const t=document.createElement("input");t.type="checkbox",t.checked=i.pattern[e],t.className="ui-checkbox",t.style.cursor="pointer",t.addEventListener("change",()=>{i.pattern[e]=t.checked}),i.patternContainer.appendChild(t)}}sr.forEach(i=>{pl(i),i.stepsInput.addEventListener("change",()=>{const e=parseInt(i.stepsInput.value,10);if(isNaN(e)||e<1||e>24)return;const t=new Array(e).fill(!1);for(let n=0;n<Math.min(e,i.numSteps);n++)t[n]=i.pattern[n];i.numSteps=e,i.pattern=t,pl(i)})});document.querySelectorAll(".ui-checkbox, input[type='number']").forEach(i=>{i.addEventListener("pointerdown",e=>{e.stopPropagation()})});let ml=0;const C_=-Math.PI/4;let _l=0,P_=je.phaseOffset;const Tn=[],oc=new ih,Is={},Wn=[],Si=[];function D_(){const i=new Gi,e=new zr({color:new Ge(je.ellipseColor),transparent:!0,opacity:je.ellipseOpacity}),t=new Ts(R_,e);t.visible=je.showEllipses,i.add(t);const n=new ka(.35,12,12),r=[],s={};return sr.forEach(a=>{const{color:o,pattern:l,numSteps:c}=a;s[o]=[];for(let u=0;u<c;u++){if(!l[u])continue;const d=new za({color:o,transparent:!0,opacity:je.sphereOpacity,blending:Ns,depthTest:!1}),f=new en(n,d),p=2*Math.PI*(u/c);f.userData={color:o,generation:Tn.length},r.push({sphere:f,offsetAngle:p}),s[o].push(f),i.add(f)}}),Object.keys(s).forEach(a=>{Is[a]&&Is[a].forEach((o,l)=>{if(l<s[a].length&&o&&s[a][l]){const c=s[a][l],u=o.getWorldPosition(new I),d=c.getWorldPosition(new I),f=new Float32Array([u.x,u.y,u.z,d.x,d.y,d.z]),p=new zt;p.setAttribute("position",new Bt(f,3));const _=new zr({color:new Ge(je.interLineColor),transparent:!0,opacity:je.interLineOpacity,alphaHash:!0}),v=new Ts(p,_);v.visible=je.showInterLines,v.userData={sphereA:o,sphereB:c},bn.add(v),Wn.push(v)}})}),Object.keys(s).forEach(a=>{Is[a]=s[a]}),r.forEach(({sphere:a})=>{let o=null,l=1/0;if(r.forEach(({sphere:c})=>{if(a===c)return;const u=a.position.distanceTo(c.position);u<l&&(l=u,o=c)}),o){const c=a.getWorldPosition(new I),u=o.getWorldPosition(new I),d=new Float32Array([c.x,c.y,c.z,u.x,u.y,u.z]),f=new zt;f.setAttribute("position",new Bt(d,3));const p=new zr({color:new Ge(je.intraLineColor),transparent:!0,opacity:je.intraLineOpacity,alphaHash:!0}),_=new Ts(f,p);_.visible=je.showIntraLines,_.userData={sphereA:a,sphereB:o},bn.add(_),Si.push(_)}}),i.userData={spheres:r,birthTime:0},i}function lc(){requestAnimationFrame(lc);const i=oc.getElapsedTime(),e=je.recessionVelocity;if(i-ml>=rc){ml=i,_l+=Oa.degToRad(je.phaseOffset);const n=D_();n.rotation.x=C_,n.rotation.y=_l,n.position.z=0,n.userData.birthTime=i,bn.add(n),Tn.push(n)}const t=[];Tn.forEach(n=>{const{spheres:r,birthTime:s}=n.userData,a=i-s;n.position.z=-a*e;const o=a/Kr%1;r.forEach(({sphere:l,offsetAngle:c})=>{const u=2*Math.PI*o+c;l.position.x=sc*Math.cos(u),l.position.y=0,l.position.z=ac*Math.sin(u)}),n.position.z<-1500&&t.push(n)}),Wn.concat(Si).forEach(n=>{if(Wn.includes(n)?(n.visible=je.showInterLines,n.material&&(n.material.color.set(je.interLineColor),n.material.opacity=je.interLineOpacity)):(n.visible=je.showIntraLines,n.material&&(n.material.color.set(je.intraLineColor),n.material.opacity=je.intraLineOpacity)),!n.userData.sphereA||!n.userData.sphereB)return;const r=n.userData.sphereA.getWorldPosition(new I),s=n.userData.sphereB.getWorldPosition(new I),a=n.geometry.attributes.position.array;a[0]=r.x,a[1]=r.y,a[2]=r.z,a[3]=s.x,a[4]=s.y,a[5]=s.z,n.geometry.attributes.position.needsUpdate=!0}),t.forEach(n=>{bn.remove(n);const r=Tn.indexOf(n);r>=0&&Tn.splice(r,1)});for(let n=Wn.length-1;n>=0;n--){const r=Wn[n];(r.userData.sphereA.position.z<-1500||r.userData.sphereB.position.z<-1500)&&(bn.remove(r),Wn.splice(n,1))}for(let n=Si.length-1;n>=0;n--){const r=Si[n];(r.userData.sphereA.position.z<-1500||r.userData.sphereB.position.z<-1500)&&(bn.remove(r),Si.splice(n,1))}tn.update(),Ii.render(bn,Qi)}let gl=!1;const L_=document.getElementById("audioPlayer"),U_=document.getElementById("playerContainer"),cc=document.getElementById("uiContainer");cc.style.display="none";L_.addEventListener("play",()=>{gl||(oc.start(),gl=!0,lc()),cc.style.display="block",U_.style.display="none"});
